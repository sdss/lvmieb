...
try:
    ...
    __version__ = get_package_version(__file__, 'sdss-OsuActor') or 'dev'
...
.. |OsuActor_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('OsuActor')
...
man_pages = [
    (master_doc, 'OsuActor', u'{0} Documentation'.format(project),
     [author], 1)
]
